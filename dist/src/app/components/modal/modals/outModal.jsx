...
var OuterModal = function (_a) {
    var isOpen = _a.isOpen;
    var _b = useModal(), openModal = _b.openModal, closeModal = _b.closeModal, modalStack = _b.modalStack;
    if (!isOpen)
        return null;
    return (<div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded-lg shadow-lg relative">
        ...
        <button onClick={function () { return openModal('innerModal'); }} className="bg-green-500 text-white py-2 px-4 rounded mt-4">
          Open Inner Modal
        </button>
