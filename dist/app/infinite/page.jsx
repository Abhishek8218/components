...
import InfoCard from '../components/postCard';
...
var Page = function () {
    ...
    }), data = _b.data, error = _b.error, isLoading = _b.isLoading, isFetching = _b.isFetching, fetchNextPage = _b.fetchNextPage, hasNextPage = _b.hasNextPage;
    var content = data === null || data === void 0 ? void 0 : data.pages.map(function (posts) { return posts.map(function (post, index) {
