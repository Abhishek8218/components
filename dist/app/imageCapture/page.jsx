...
export default function Home() {
    var _this = this;
    var handleSaveImage = function (imageData) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return (<div>
      <CameraCapture Customshape="oval" onCapture={function () { return console.log('Image captured'); }} onRetake={function () { return console.log('Retake image'); }} onSave={handleSaveImage} onShapeChange={function () { return console.log('Shape changed'); }}>
        {/* Custom buttons */}
