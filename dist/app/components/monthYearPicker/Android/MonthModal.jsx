...
var MobileMonthModal = function (_a) {
    ...
    return (<div className={"fixed inset-0 flex items-center justify-center z-[60] px-10 ".concat(showMonthModal ? '' : 'hidden')}>
    ...
    <button className='text-blue-500  pt-2' onClick={setCurrentMonth}>Current</button>
      </div>
    </div>
    </div>
  </div>);
