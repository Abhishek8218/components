...
var InnerModal = function (_a) {
    ...
    var _b = useModal(), closeModal = _b.closeModal, modalStack = _b.modalStack, openModal = _b.openModal;
    if (!isOpen)
        return null;
    return (<div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded-lg shadow-lg relative">
        ...
        <button onClick={function () { return openModal('thirdLevelModal'); }} className="bg-blue-500 text-white py-2 px-4 rounded mt-4">
